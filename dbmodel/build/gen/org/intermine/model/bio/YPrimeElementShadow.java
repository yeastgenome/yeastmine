...
public class YPrimeElementShadow implements YPrimeElement, ShadowClass
{
    public static final Class<YPrimeElement> shadowOf = YPrimeElement.class;
    // Ref: org.intermine.model.bio.YPrimeElement.telomere
    protected org.intermine.model.InterMineObject telomere;
    public org.intermine.model.bio.Telomere getTelomere() { if (telomere instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Telomere) ((org.intermine.objectstore.proxy.ProxyReference) telomere).getObject()); }; return (org.intermine.model.bio.Telomere) telomere; }
    public void setTelomere(final org.intermine.model.bio.Telomere telomere) { this.telomere = telomere; }
    public void proxyTelomere(final org.intermine.objectstore.proxy.ProxyReference telomere) { this.telomere = telomere; }
    public org.intermine.model.InterMineObject proxGetTelomere() { return telomere; }

    // Col: org.intermine.model.bio.YPrimeElement.arsconsensussequences
    protected java.util.Set<org.intermine.model.bio.ARSConsensusSequence> arsconsensussequences = new java.util.HashSet<org.intermine.model.bio.ARSConsensusSequence>();
    public java.util.Set<org.intermine.model.bio.ARSConsensusSequence> getArsconsensussequences() { return arsconsensussequences; }
    public void setArsconsensussequences(final java.util.Set<org.intermine.model.bio.ARSConsensusSequence> arsconsensussequences) { this.arsconsensussequences = arsconsensussequences; }
    public void addArsconsensussequences(final org.intermine.model.bio.ARSConsensusSequence arg) { arsconsensussequences.add(arg); }

    // Col: org.intermine.model.bio.YPrimeElement.repeatregions
    protected java.util.Set<org.intermine.model.bio.RepeatRegion> repeatregions = new java.util.HashSet<org.intermine.model.bio.RepeatRegion>();
    public java.util.Set<org.intermine.model.bio.RepeatRegion> getRepeatregions() { return repeatregions; }
    public void setRepeatregions(final java.util.Set<org.intermine.model.bio.RepeatRegion> repeatregions) { this.repeatregions = repeatregions; }
    public void addRepeatregions(final org.intermine.model.bio.RepeatRegion arg) { repeatregions.add(arg); }

    // Ref: org.intermine.model.bio.RepeatRegion.yprimeelement
    protected org.intermine.model.InterMineObject yprimeelement;
    public org.intermine.model.bio.YPrimeElement getYprimeelement() { if (yprimeelement instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.YPrimeElement) ((org.intermine.objectstore.proxy.ProxyReference) yprimeelement).getObject()); }; return (org.intermine.model.bio.YPrimeElement) yprimeelement; }
    public void setYprimeelement(final org.intermine.model.bio.YPrimeElement yprimeelement) { this.yprimeelement = yprimeelement; }
    public void proxyYprimeelement(final org.intermine.objectstore.proxy.ProxyReference yprimeelement) { this.yprimeelement = yprimeelement; }
    public org.intermine.model.InterMineObject proxGetYprimeelement() { return yprimeelement; }
    ...
    // Col: org.intermine.model.bio.Telomere.XElementCombinatorialRepeats
    protected java.util.Set<org.intermine.model.bio.XElementCombinatorialRepeat> XElementCombinatorialRepeats = new java.util.HashSet<org.intermine.model.bio.XElementCombinatorialRepeat>();
    public java.util.Set<org.intermine.model.bio.XElementCombinatorialRepeat> getxElementCombinatorialRepeats() { return XElementCombinatorialRepeats; }
    public void setxElementCombinatorialRepeats(final java.util.Set<org.intermine.model.bio.XElementCombinatorialRepeat> XElementCombinatorialRepeats) { this.XElementCombinatorialRepeats = XElementCombinatorialRepeats; }
    public void addxElementCombinatorialRepeats(final org.intermine.model.bio.XElementCombinatorialRepeat arg) { XElementCombinatorialRepeats.add(arg); }

    // Col: org.intermine.model.bio.Telomere.telomericRepeats
    protected java.util.Set<org.intermine.model.bio.TelomericRepeat> telomericRepeats = new java.util.HashSet<org.intermine.model.bio.TelomericRepeat>();
    public java.util.Set<org.intermine.model.bio.TelomericRepeat> getTelomericRepeats() { return telomericRepeats; }
    public void setTelomericRepeats(final java.util.Set<org.intermine.model.bio.TelomericRepeat> telomericRepeats) { this.telomericRepeats = telomericRepeats; }
    public void addTelomericRepeats(final org.intermine.model.bio.TelomericRepeat arg) { telomericRepeats.add(arg); }

    // Col: org.intermine.model.bio.Telomere.YPrimeElements
    protected java.util.Set<org.intermine.model.bio.YPrimeElement> YPrimeElements = new java.util.HashSet<org.intermine.model.bio.YPrimeElement>();
    public java.util.Set<org.intermine.model.bio.YPrimeElement> getyPrimeElements() { return YPrimeElements; }
    public void setyPrimeElements(final java.util.Set<org.intermine.model.bio.YPrimeElement> YPrimeElements) { this.YPrimeElements = YPrimeElements; }
    public void addyPrimeElements(final org.intermine.model.bio.YPrimeElement arg) { YPrimeElements.add(arg); }

    // Col: org.intermine.model.bio.Telomere.XElements
    protected java.util.Set<org.intermine.model.bio.XElement> XElements = new java.util.HashSet<org.intermine.model.bio.XElement>();
    public java.util.Set<org.intermine.model.bio.XElement> getxElements() { return XElements; }
    public void setxElements(final java.util.Set<org.intermine.model.bio.XElement> XElements) { this.XElements = XElements; }
    public void addxElements(final org.intermine.model.bio.XElement arg) { XElements.add(arg); }

    @Override public boolean equals(Object o) { return (o instanceof YPrimeElement && id != null) ? id.equals(((YPrimeElement)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "YPrimeElement [briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", featAttribute=" + (featAttribute == null ? "null" : "\"" + featAttribute + "\"") + ", featureType=" + (featureType == null ? "null" : "\"" + featureType + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", strain=" + (strain == null ? "null" : (strain.getId() == null ? "no id" : strain.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", telomere=" + (telomere == null ? "null" : (telomere.getId() == null ? "no id" : telomere.getId().toString())) + ", yprimeelement=" + (yprimeelement == null ? "null" : (yprimeelement.getId() == null ? "no id" : yprimeelement.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("telomere".equals(fieldName)) {
            if (telomere instanceof ProxyReference) {
                return ((ProxyReference) telomere).getObject();
            } else {
                return telomere;
            }
        }
        if ("arsconsensussequences".equals(fieldName)) {
            return arsconsensussequences;
        }
        if ("repeatregions".equals(fieldName)) {
            return repeatregions;
        }
        if ("yprimeelement".equals(fieldName)) {
            if (yprimeelement instanceof ProxyReference) {
                return ((ProxyReference) yprimeelement).getObject();
            } else {
                return yprimeelement;
            }
        }
        ...
        if ("XElementCombinatorialRepeats".equals(fieldName)) {
            return XElementCombinatorialRepeats;
        }
        if ("telomericRepeats".equals(fieldName)) {
            return telomericRepeats;
        }
        if ("YPrimeElements".equals(fieldName)) {
            return YPrimeElements;
        }
        if ("XElements".equals(fieldName)) {
            return XElements;
        }
        if (!org.intermine.model.bio.YPrimeElement.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("telomere".equals(fieldName)) {
            telomere = (org.intermine.model.InterMineObject) value;
        } else if ("arsconsensussequences".equals(fieldName)) {
            arsconsensussequences = (java.util.Set) value;
        } else if ("repeatregions".equals(fieldName)) {
            repeatregions = (java.util.Set) value;
        } else if ("yprimeelement".equals(fieldName)) {
            yprimeelement = (org.intermine.model.InterMineObject) value;
        ...
        } else if ("XElementCombinatorialRepeats".equals(fieldName)) {
            XElementCombinatorialRepeats = (java.util.Set) value;
        } else if ("telomericRepeats".equals(fieldName)) {
            telomericRepeats = (java.util.Set) value;
        } else if ("YPrimeElements".equals(fieldName)) {
            YPrimeElements = (java.util.Set) value;
        } else if ("XElements".equals(fieldName)) {
            XElements = (java.util.Set) value;
        } else {
            if (!org.intermine.model.bio.YPrimeElement.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("telomere".equals(fieldName)) {
            return org.intermine.model.bio.Telomere.class;
        }
        if ("arsconsensussequences".equals(fieldName)) {
        ...
        if ("yprimeelement".equals(fieldName)) {
            return org.intermine.model.bio.YPrimeElement.class;
        }
        if ("briefDescription".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.YPrimeElement.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.YPrimeElement.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.YPrimeElementShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.YPrimeElement");
        if (telomere != null) {
            sb.append("$_^rtelomere$_^").append(telomere.getId());
        }
        if (yprimeelement != null) {
            sb.append("$_^ryprimeelement$_^").append(yprimeelement.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.YPrimeElementShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.YPrimeElement)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rtelomere".equals(notXml[i])) {
                i++;
                telomere = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Telomere.class);
                i++;
            };
            if ((i < notXml.length) &&"ryprimeelement".equals(notXml[i])) {
                i++;
                yprimeelement = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.YPrimeElement.class);
                i++;
            };
        ...
        arsconsensussequences = new ProxyCollection<org.intermine.model.bio.ARSConsensusSequence>(os, this, "arsconsensussequences", org.intermine.model.bio.ARSConsensusSequence.class);
        repeatregions = new ProxyCollection<org.intermine.model.bio.RepeatRegion>(os, this, "repeatregions", org.intermine.model.bio.RepeatRegion.class);
        ...
        XElementCombinatorialRepeats = new ProxyCollection<org.intermine.model.bio.XElementCombinatorialRepeat>(os, this, "XElementCombinatorialRepeats", org.intermine.model.bio.XElementCombinatorialRepeat.class);
        telomericRepeats = new ProxyCollection<org.intermine.model.bio.TelomericRepeat>(os, this, "telomericRepeats", org.intermine.model.bio.TelomericRepeat.class);
        YPrimeElements = new ProxyCollection<org.intermine.model.bio.YPrimeElement>(os, this, "YPrimeElements", org.intermine.model.bio.YPrimeElement.class);
        XElements = new ProxyCollection<org.intermine.model.bio.XElement>(os, this, "XElements", org.intermine.model.bio.XElement.class);
    }
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("arsconsensussequences".equals(fieldName)) {
            arsconsensussequences.add((org.intermine.model.bio.ARSConsensusSequence) element);
        } else if ("repeatregions".equals(fieldName)) {
            repeatregions.add((org.intermine.model.bio.RepeatRegion) element);
        } else if ("overlappingFeatures".equals(fieldName)) {
            ...
            XElementCombinatorialRepeats.add((org.intermine.model.bio.XElementCombinatorialRepeat) element);
        } else if ("telomericRepeats".equals(fieldName)) {
            telomericRepeats.add((org.intermine.model.bio.TelomericRepeat) element);
        } else if ("YPrimeElements".equals(fieldName)) {
            YPrimeElements.add((org.intermine.model.bio.YPrimeElement) element);
        } else if ("XElements".equals(fieldName)) {
            XElements.add((org.intermine.model.bio.XElement) element);
        } else {
            if (!org.intermine.model.bio.YPrimeElement.class.equals(getClass())) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("arsconsensussequences".equals(fieldName)) {
            return org.intermine.model.bio.ARSConsensusSequence.class;
        }
        if ("repeatregions".equals(fieldName)) {
            return org.intermine.model.bio.RepeatRegion.class;
        }
        if ("overlappingFeatures".equals(fieldName)) {
        ...
        if ("XElementCombinatorialRepeats".equals(fieldName)) {
            return org.intermine.model.bio.XElementCombinatorialRepeat.class;
        }
        if ("telomericRepeats".equals(fieldName)) {
            return org.intermine.model.bio.TelomericRepeat.class;
        }
        if ("YPrimeElements".equals(fieldName)) {
            return org.intermine.model.bio.YPrimeElement.class;
        }
        ...
        if (!org.intermine.model.bio.YPrimeElement.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.YPrimeElement.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
