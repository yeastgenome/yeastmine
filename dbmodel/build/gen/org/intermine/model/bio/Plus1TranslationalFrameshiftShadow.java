...
public class Plus1TranslationalFrameshiftShadow implements Plus1TranslationalFrameshift, ShadowClass
{
    public static final Class<Plus1TranslationalFrameshift> shadowOf = Plus1TranslationalFrameshift.class;
    // Ref: org.intermine.model.bio.Plus1TranslationalFrameshift.transposableelementgene
    protected org.intermine.model.InterMineObject transposableelementgene;
    public org.intermine.model.bio.TransposableElementGene getTransposableelementgene() { if (transposableelementgene instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.TransposableElementGene) ((org.intermine.objectstore.proxy.ProxyReference) transposableelementgene).getObject()); }; return (org.intermine.model.bio.TransposableElementGene) transposableelementgene; }
    public void setTransposableelementgene(final org.intermine.model.bio.TransposableElementGene transposableelementgene) { this.transposableelementgene = transposableelementgene; }
    public void proxyTransposableelementgene(final org.intermine.objectstore.proxy.ProxyReference transposableelementgene) { this.transposableelementgene = transposableelementgene; }
    public org.intermine.model.InterMineObject proxGetTransposableelementgene() { return transposableelementgene; }

    // Ref: org.intermine.model.bio.Plus1TranslationalFrameshift.pseudogene
    ...
    // Ref: org.intermine.model.bio.Plus1TranslationalFrameshift.orf
    ...
    @Override public boolean equals(Object o) { return (o instanceof Plus1TranslationalFrameshift && id != null) ? id.equals(((Plus1TranslationalFrameshift)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Plus1TranslationalFrameshift [briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", featAttribute=" + (featAttribute == null ? "null" : "\"" + featAttribute + "\"") + ", featureType=" + (featureType == null ? "null" : "\"" + featureType + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", orf=" + (orf == null ? "null" : (orf.getId() == null ? "no id" : orf.getId().toString())) + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", pseudogene=" + (pseudogene == null ? "null" : (pseudogene.getId() == null ? "no id" : pseudogene.getId().toString())) + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", strain=" + (strain == null ? "null" : (strain.getId() == null ? "no id" : strain.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", transposableelementgene=" + (transposableelementgene == null ? "null" : (transposableelementgene.getId() == null ? "no id" : transposableelementgene.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("transposableelementgene".equals(fieldName)) {
            if (transposableelementgene instanceof ProxyReference) {
                return ((ProxyReference) transposableelementgene).getObject();
            } else {
                return transposableelementgene;
            }
        }
        ...
        if (!org.intermine.model.bio.Plus1TranslationalFrameshift.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("transposableelementgene".equals(fieldName)) {
            transposableelementgene = (org.intermine.model.InterMineObject) value;
        } else if ("pseudogene".equals(fieldName)) {
            pseudogene = (org.intermine.model.InterMineObject) value;
        } else if ("orf".equals(fieldName)) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("transposableelementgene".equals(fieldName)) {
            return org.intermine.model.bio.TransposableElementGene.class;
        }
        if ("pseudogene".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.Plus1TranslationalFrameshift.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Plus1TranslationalFrameshift.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.Plus1TranslationalFrameshiftShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Plus1TranslationalFrameshift");
        if (transposableelementgene != null) {
            sb.append("$_^rtransposableelementgene$_^").append(transposableelementgene.getId());
        }
        if (pseudogene != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.Plus1TranslationalFrameshiftShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Plus1TranslationalFrameshift)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rtransposableelementgene".equals(notXml[i])) {
                i++;
                transposableelementgene = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.TransposableElementGene.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Plus1TranslationalFrameshift.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Plus1TranslationalFrameshift.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
