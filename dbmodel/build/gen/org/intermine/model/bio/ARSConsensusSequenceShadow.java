...
public class ARSConsensusSequenceShadow implements ARSConsensusSequence, ShadowClass
{
    public static final Class<ARSConsensusSequence> shadowOf = ARSConsensusSequence.class;
    // Ref: org.intermine.model.bio.ARSConsensusSequence.xelement
    ...
    // Ref: org.intermine.model.bio.ARSConsensusSequence.ars
    protected org.intermine.model.InterMineObject ars;
    public org.intermine.model.bio.ARS getArs() { if (ars instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.ARS) ((org.intermine.objectstore.proxy.ProxyReference) ars).getObject()); }; return (org.intermine.model.bio.ARS) ars; }
    public void setArs(final org.intermine.model.bio.ARS ars) { this.ars = ars; }
    public void proxyArs(final org.intermine.objectstore.proxy.ProxyReference ars) { this.ars = ars; }
    public org.intermine.model.InterMineObject proxGetArs() { return ars; }

    // Ref: org.intermine.model.bio.ARSConsensusSequence.yprimeelement
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("ars".equals(fieldName)) {
            if (ars instanceof ProxyReference) {
                return ((ProxyReference) ars).getObject();
            } else {
                return ars;
            }
        }
        ...
        if (!org.intermine.model.bio.ARSConsensusSequence.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("ars".equals(fieldName)) {
            ars = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if ("ars".equals(fieldName)) {
            return org.intermine.model.bio.ARS.class;
        }
        if ("yprimeelement".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.ARSConsensusSequence.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ARSConsensusSequence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ARSConsensusSequenceShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ARSConsensusSequence");
        if (xelement != null) {
            sb.append("$_^rxelement$_^").append(xelement.getId());
        }
        if (ars != null) {
            sb.append("$_^rars$_^").append(ars.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ARSConsensusSequenceShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ARSConsensusSequence)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) &&"rars".equals(notXml[i])) {
                i++;
                ars = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.ARS.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ARSConsensusSequence.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ARSConsensusSequence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
