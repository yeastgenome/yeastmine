...
public class MatingTypeRegionShadow implements MatingTypeRegion, ShadowClass
{
    public static final Class<MatingTypeRegion> shadowOf = MatingTypeRegion.class;
    // Ref: org.intermine.model.bio.MatingTypeRegion.X_regions
    protected org.intermine.model.InterMineObject X_regions;
    public org.intermine.model.bio.X_region getx_regions() { if (X_regions instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.X_region) ((org.intermine.objectstore.proxy.ProxyReference) X_regions).getObject()); }; return (org.intermine.model.bio.X_region) X_regions; }
    public void setx_regions(final org.intermine.model.bio.X_region X_regions) { this.X_regions = X_regions; }
    public void proxyx_regions(final org.intermine.objectstore.proxy.ProxyReference X_regions) { this.X_regions = X_regions; }
    public org.intermine.model.InterMineObject proxGetx_regions() { return X_regions; }

    // Ref: org.intermine.model.bio.MatingTypeRegion.Z2_regions
    protected org.intermine.model.InterMineObject Z2_regions;
    public org.intermine.model.bio.Z2_region getz2_regions() { if (Z2_regions instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Z2_region) ((org.intermine.objectstore.proxy.ProxyReference) Z2_regions).getObject()); }; return (org.intermine.model.bio.Z2_region) Z2_regions; }
    public void setz2_regions(final org.intermine.model.bio.Z2_region Z2_regions) { this.Z2_regions = Z2_regions; }
    public void proxyz2_regions(final org.intermine.objectstore.proxy.ProxyReference Z2_regions) { this.Z2_regions = Z2_regions; }
    public org.intermine.model.InterMineObject proxGetz2_regions() { return Z2_regions; }

    // Ref: org.intermine.model.bio.MatingTypeRegion.Y_regions
    protected org.intermine.model.InterMineObject Y_regions;
    public org.intermine.model.bio.Y_region gety_regions() { if (Y_regions instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Y_region) ((org.intermine.objectstore.proxy.ProxyReference) Y_regions).getObject()); }; return (org.intermine.model.bio.Y_region) Y_regions; }
    public void sety_regions(final org.intermine.model.bio.Y_region Y_regions) { this.Y_regions = Y_regions; }
    public void proxyy_regions(final org.intermine.objectstore.proxy.ProxyReference Y_regions) { this.Y_regions = Y_regions; }
    public org.intermine.model.InterMineObject proxGety_regions() { return Y_regions; }

    // Ref: org.intermine.model.bio.MatingTypeRegion.Z1_regions
    protected org.intermine.model.InterMineObject Z1_regions;
    public org.intermine.model.bio.Z1_region getz1_regions() { if (Z1_regions instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Z1_region) ((org.intermine.objectstore.proxy.ProxyReference) Z1_regions).getObject()); }; return (org.intermine.model.bio.Z1_region) Z1_regions; }
    public void setz1_regions(final org.intermine.model.bio.Z1_region Z1_regions) { this.Z1_regions = Z1_regions; }
    public void proxyz1_regions(final org.intermine.objectstore.proxy.ProxyReference Z1_regions) { this.Z1_regions = Z1_regions; }
    public org.intermine.model.InterMineObject proxGetz1_regions() { return Z1_regions; }

    // Ref: org.intermine.model.bio.MatingTypeRegion.W_regions
    protected org.intermine.model.InterMineObject W_regions;
    public org.intermine.model.bio.W_region getw_regions() { if (W_regions instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.W_region) ((org.intermine.objectstore.proxy.ProxyReference) W_regions).getObject()); }; return (org.intermine.model.bio.W_region) W_regions; }
    public void setw_regions(final org.intermine.model.bio.W_region W_regions) { this.W_regions = W_regions; }
    public void proxyw_regions(final org.intermine.objectstore.proxy.ProxyReference W_regions) { this.W_regions = W_regions; }
    public org.intermine.model.InterMineObject proxGetw_regions() { return W_regions; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof MatingTypeRegion && id != null) ? id.equals(((MatingTypeRegion)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MatingTypeRegion [W_regions=" + (W_regions == null ? "null" : (W_regions.getId() == null ? "no id" : W_regions.getId().toString())) + ", X_regions=" + (X_regions == null ? "null" : (X_regions.getId() == null ? "no id" : X_regions.getId().toString())) + ", Y_regions=" + (Y_regions == null ? "null" : (Y_regions.getId() == null ? "no id" : Y_regions.getId().toString())) + ", Z1_regions=" + (Z1_regions == null ? "null" : (Z1_regions.getId() == null ? "no id" : Z1_regions.getId().toString())) + ", Z2_regions=" + (Z2_regions == null ? "null" : (Z2_regions.getId() == null ? "no id" : Z2_regions.getId().toString())) + ", briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", featAttribute=" + (featAttribute == null ? "null" : "\"" + featAttribute + "\"") + ", featureType=" + (featureType == null ? "null" : "\"" + featureType + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", strain=" + (strain == null ? "null" : (strain.getId() == null ? "no id" : strain.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("X_regions".equals(fieldName)) {
            if (X_regions instanceof ProxyReference) {
                return ((ProxyReference) X_regions).getObject();
            } else {
                return X_regions;
            }
        }
        if ("Z2_regions".equals(fieldName)) {
            if (Z2_regions instanceof ProxyReference) {
                return ((ProxyReference) Z2_regions).getObject();
            } else {
                return Z2_regions;
            }
        }
        if ("Y_regions".equals(fieldName)) {
            if (Y_regions instanceof ProxyReference) {
                return ((ProxyReference) Y_regions).getObject();
            } else {
                return Y_regions;
            }
        }
        if ("Z1_regions".equals(fieldName)) {
            if (Z1_regions instanceof ProxyReference) {
                return ((ProxyReference) Z1_regions).getObject();
            } else {
                return Z1_regions;
            }
        }
        if ("W_regions".equals(fieldName)) {
            if (W_regions instanceof ProxyReference) {
                return ((ProxyReference) W_regions).getObject();
            } else {
                return W_regions;
            }
        }
        ...
        if (!org.intermine.model.bio.MatingTypeRegion.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("X_regions".equals(fieldName)) {
            X_regions = (org.intermine.model.InterMineObject) value;
        } else if ("Z2_regions".equals(fieldName)) {
            Z2_regions = (org.intermine.model.InterMineObject) value;
        } else if ("Y_regions".equals(fieldName)) {
            Y_regions = (org.intermine.model.InterMineObject) value;
        } else if ("Z1_regions".equals(fieldName)) {
            Z1_regions = (org.intermine.model.InterMineObject) value;
        } else if ("W_regions".equals(fieldName)) {
            W_regions = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("X_regions".equals(fieldName)) {
            return org.intermine.model.bio.X_region.class;
        }
        if ("Z2_regions".equals(fieldName)) {
            return org.intermine.model.bio.Z2_region.class;
        }
        if ("Y_regions".equals(fieldName)) {
            return org.intermine.model.bio.Y_region.class;
        }
        if ("Z1_regions".equals(fieldName)) {
            return org.intermine.model.bio.Z1_region.class;
        }
        if ("W_regions".equals(fieldName)) {
            return org.intermine.model.bio.W_region.class;
        }
        if ("briefDescription".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.MatingTypeRegion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MatingTypeRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MatingTypeRegionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.MatingTypeRegion");
        if (X_regions != null) {
            sb.append("$_^rX_regions$_^").append(X_regions.getId());
        }
        if (Z2_regions != null) {
            sb.append("$_^rZ2_regions$_^").append(Z2_regions.getId());
        }
        if (Y_regions != null) {
            sb.append("$_^rY_regions$_^").append(Y_regions.getId());
        }
        if (Z1_regions != null) {
            sb.append("$_^rZ1_regions$_^").append(Z1_regions.getId());
        }
        if (W_regions != null) {
            sb.append("$_^rW_regions$_^").append(W_regions.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MatingTypeRegionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MatingTypeRegion)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rX_regions".equals(notXml[i])) {
                i++;
                X_regions = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.X_region.class);
                i++;
            };
            if ((i < notXml.length) &&"rZ2_regions".equals(notXml[i])) {
                i++;
                Z2_regions = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Z2_region.class);
                i++;
            };
            if ((i < notXml.length) &&"rY_regions".equals(notXml[i])) {
                i++;
                Y_regions = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Y_region.class);
                i++;
            };
            if ((i < notXml.length) &&"rZ1_regions".equals(notXml[i])) {
                i++;
                Z1_regions = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Z1_region.class);
                i++;
            };
            if ((i < notXml.length) &&"rW_regions".equals(notXml[i])) {
                i++;
                W_regions = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.W_region.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MatingTypeRegion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MatingTypeRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
