...
public class MRNAShadow implements MRNA, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.MRNA.fivePrimeDataSet
    protected java.lang.String fivePrimeDataSet;
    public java.lang.String getFivePrimeDataSet() { return fivePrimeDataSet; }
    public void setFivePrimeDataSet(final java.lang.String fivePrimeDataSet) { this.fivePrimeDataSet = fivePrimeDataSet; }

    // Attr: org.intermine.model.bio.MRNA.note
    protected java.lang.String note;
    public java.lang.String getNote() { return note; }
    public void setNote(final java.lang.String note) { this.note = note; }

    // Attr: org.intermine.model.bio.MRNA.threePrimeScore
    protected java.lang.String threePrimeScore;
    public java.lang.String getThreePrimeScore() { return threePrimeScore; }
    public void setThreePrimeScore(final java.lang.String threePrimeScore) { this.threePrimeScore = threePrimeScore; }

    // Attr: org.intermine.model.bio.MRNA.glucoseCount
    protected java.lang.String glucoseCount;
    public java.lang.String getGlucoseCount() { return glucoseCount; }
    public void setGlucoseCount(final java.lang.String glucoseCount) { this.glucoseCount = glucoseCount; }

    // Attr: org.intermine.model.bio.MRNA.threePrimeDataSet
    protected java.lang.String threePrimeDataSet;
    public java.lang.String getThreePrimeDataSet() { return threePrimeDataSet; }
    public void setThreePrimeDataSet(final java.lang.String threePrimeDataSet) { this.threePrimeDataSet = threePrimeDataSet; }

    // Attr: org.intermine.model.bio.MRNA.galactoseCount
    protected java.lang.String galactoseCount;
    public java.lang.String getGalactoseCount() { return galactoseCount; }
    public void setGalactoseCount(final java.lang.String galactoseCount) { this.galactoseCount = galactoseCount; }

    // Attr: org.intermine.model.bio.MRNA.fivePrimeScore
    protected java.lang.String fivePrimeScore;
    public java.lang.String getFivePrimeScore() { return fivePrimeScore; }
    public void setFivePrimeScore(final java.lang.String fivePrimeScore) { this.fivePrimeScore = fivePrimeScore; }
    ...
    @Override public String toString() { return "MRNA [briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", featAttribute=" + (featAttribute == null ? "null" : "\"" + featAttribute + "\"") + ", featureType=" + (featureType == null ? "null" : "\"" + featureType + "\"") + ", fivePrimeDataSet=" + (fivePrimeDataSet == null ? "null" : "\"" + fivePrimeDataSet + "\"") + ", fivePrimeScore=" + (fivePrimeScore == null ? "null" : "\"" + fivePrimeScore + "\"") + ", galactoseCount=" + (galactoseCount == null ? "null" : "\"" + galactoseCount + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", glucoseCount=" + (glucoseCount == null ? "null" : "\"" + glucoseCount + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", note=" + (note == null ? "null" : "\"" + note + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", protein=" + (protein == null ? "null" : (protein.getId() == null ? "no id" : protein.getId().toString())) + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", strain=" + (strain == null ? "null" : (strain.getId() == null ? "no id" : strain.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", threePrimeDataSet=" + (threePrimeDataSet == null ? "null" : "\"" + threePrimeDataSet + "\"") + ", threePrimeScore=" + (threePrimeScore == null ? "null" : "\"" + threePrimeScore + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("fivePrimeDataSet".equals(fieldName)) {
            return fivePrimeDataSet;
        }
        if ("note".equals(fieldName)) {
            return note;
        }
        if ("threePrimeScore".equals(fieldName)) {
            return threePrimeScore;
        }
        if ("glucoseCount".equals(fieldName)) {
            return glucoseCount;
        }
        if ("threePrimeDataSet".equals(fieldName)) {
            return threePrimeDataSet;
        }
        if ("galactoseCount".equals(fieldName)) {
            return galactoseCount;
        }
        if ("fivePrimeScore".equals(fieldName)) {
            return fivePrimeScore;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("fivePrimeDataSet".equals(fieldName)) {
            fivePrimeDataSet = (java.lang.String) value;
        } else if ("note".equals(fieldName)) {
            note = (java.lang.String) value;
        } else if ("threePrimeScore".equals(fieldName)) {
            threePrimeScore = (java.lang.String) value;
        } else if ("glucoseCount".equals(fieldName)) {
            glucoseCount = (java.lang.String) value;
        } else if ("threePrimeDataSet".equals(fieldName)) {
            threePrimeDataSet = (java.lang.String) value;
        } else if ("galactoseCount".equals(fieldName)) {
            galactoseCount = (java.lang.String) value;
        } else if ("fivePrimeScore".equals(fieldName)) {
            fivePrimeScore = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (fivePrimeDataSet != null) {
            sb.append("$_^afivePrimeDataSet$_^");
            String string = fivePrimeDataSet;
            while (string != null) {
        ...
        if (threePrimeScore != null) {
            sb.append("$_^athreePrimeScore$_^");
            String string = threePrimeScore;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (glucoseCount != null) {
            sb.append("$_^aglucoseCount$_^");
            String string = glucoseCount;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (threePrimeDataSet != null) {
            sb.append("$_^athreePrimeDataSet$_^");
            String string = threePrimeDataSet;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (galactoseCount != null) {
            sb.append("$_^agalactoseCount$_^");
            String string = galactoseCount;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (fivePrimeScore != null) {
            sb.append("$_^afivePrimeScore$_^");
            String string = fivePrimeScore;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "afivePrimeDataSet".equals(notXml[i])) {
                i++;
                ...
                fivePrimeDataSet = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "athreePrimeScore".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                threePrimeScore = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "aglucoseCount".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                glucoseCount = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "athreePrimeDataSet".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                threePrimeDataSet = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "agalactoseCount".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                galactoseCount = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "afivePrimeScore".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                fivePrimeScore = string == null ? notXml[i] : string.toString();
                i++;
            }
