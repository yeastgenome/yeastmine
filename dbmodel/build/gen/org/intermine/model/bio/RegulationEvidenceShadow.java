...
public class RegulationEvidenceShadow implements RegulationEvidence, ShadowClass
{
    public static final Class<RegulationEvidence> shadowOf = RegulationEvidence.class;
    // Col: org.intermine.model.bio.RegulationEvidence.publications
    ...
    @Override public boolean equals(Object o) { return (o instanceof RegulationEvidence && id != null) ? id.equals(((RegulationEvidence)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "RegulationEvidence [id=" + id + ", ontologyTerm=" + (ontologyTerm == null ? "null" : (ontologyTerm.getId() == null ? "no id" : ontologyTerm.getId().toString())) + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.RegulationEvidence.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.RegulationEvidence.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.RegulationEvidence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.RegulationEvidenceShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.RegulationEvidence");
        if (qualifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.RegulationEvidenceShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.RegulationEvidence)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.RegulationEvidence.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.RegulationEvidence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
