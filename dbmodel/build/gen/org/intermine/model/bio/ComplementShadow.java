...
public class ComplementShadow implements Complement, ShadowClass
{
    public static final Class<Complement> shadowOf = Complement.class;
    // Attr: org.intermine.model.bio.Complement.source
    ...
    // Attr: org.intermine.model.bio.Complement.direction
    ...
    // Attr: org.intermine.model.bio.Complement.type
    protected java.lang.String type;
    public java.lang.String getType() { return type; }
    public void setType(final java.lang.String type) { this.type = type; }

    // Attr: org.intermine.model.bio.Complement.notes
    ...
    // Ref: org.intermine.model.bio.Complement.publication
    ...
    // Ref: org.intermine.model.bio.Complement.gene
    ...
    // Ref: org.intermine.model.bio.Complement.complement
    protected org.intermine.model.InterMineObject complement;
    public org.intermine.model.bio.Gene getComplement() { if (complement instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Gene) ((org.intermine.objectstore.proxy.ProxyReference) complement).getObject()); }; return (org.intermine.model.bio.Gene) complement; }
    public void setComplement(final org.intermine.model.bio.Gene complement) { this.complement = complement; }
    public void proxyComplement(final org.intermine.objectstore.proxy.ProxyReference complement) { this.complement = complement; }
    public org.intermine.model.InterMineObject proxGetComplement() { return complement; }

    // Col: org.intermine.model.bio.Complement.crossReferences
    ...
    // Col: org.intermine.model.bio.Complement.dataSets
    ...
    @Override public boolean equals(Object o) { return (o instanceof Complement && id != null) ? id.equals(((Complement)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Complement [complement=" + (complement == null ? "null" : (complement.getId() == null ? "no id" : complement.getId().toString())) + ", direction=" + (direction == null ? "null" : "\"" + direction + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=" + id + ", notes=" + (notes == null ? "null" : "\"" + notes + "\"") + ", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("complement".equals(fieldName)) {
            if (complement instanceof ProxyReference) {
                return ((ProxyReference) complement).getObject();
            } else {
                return complement;
            }
        }
        ...
        if (!org.intermine.model.bio.Complement.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("complement".equals(fieldName)) {
            complement = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Complement.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Complement.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ComplementShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Complement");
        if (source != null) {
        ...
        if (complement != null) {
            sb.append("$_^rcomplement$_^").append(complement.getId());
        }
        if (id != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ComplementShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Complement)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) &&"rcomplement".equals(notXml[i])) {
                i++;
                complement = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Gene.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Complement.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Complement.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
