...
public class NoncodingExonShadow implements NoncodingExon, ShadowClass
{
    public static final Class<NoncodingExon> shadowOf = NoncodingExon.class;
    // Ref: org.intermine.model.bio.NoncodingExon.ncrna_gene
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.NoncodingExon.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.NoncodingExon.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.NoncodingExon.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.NoncodingExonShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.NoncodingExon");
        if (ncrna_gene != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.NoncodingExonShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.NoncodingExon)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.NoncodingExon.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.NoncodingExon.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
