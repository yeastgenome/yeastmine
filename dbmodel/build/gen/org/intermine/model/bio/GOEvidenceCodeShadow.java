...
public class GOEvidenceCodeShadow implements GOEvidenceCode, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.GOEvidenceCode.withText
    ...
    // Attr: org.intermine.model.bio.GOEvidenceCode.annotType
    ...
    @Override public String toString() { return "GOEvidenceCode [annotType=" + (annotType == null ? "null" : "\"" + annotType + "\"") + ", code=" + (code == null ? "null" : "\"" + code + "\"") + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", url=" + (url == null ? "null" : "\"" + url + "\"") + ", withText=" + (withText == null ? "null" : "\"" + withText + "\"") + "]"; }
