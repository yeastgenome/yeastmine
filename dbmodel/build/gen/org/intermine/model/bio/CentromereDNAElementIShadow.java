...
public class CentromereDNAElementIShadow implements CentromereDNAElementI, ShadowClass
{
    public static final Class<CentromereDNAElementI> shadowOf = CentromereDNAElementI.class;
    // Ref: org.intermine.model.bio.CentromereDNAElementI.centromere
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementI.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementI.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.CentromereDNAElementI.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.CentromereDNAElementIShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.CentromereDNAElementI");
        if (centromere != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.CentromereDNAElementIShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.CentromereDNAElementI)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementI.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.CentromereDNAElementI.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
