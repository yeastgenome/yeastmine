...
public class CentromereDNAElementIIShadow implements CentromereDNAElementII, ShadowClass
{
    public static final Class<CentromereDNAElementII> shadowOf = CentromereDNAElementII.class;
    // Ref: org.intermine.model.bio.CentromereDNAElementII.centromere
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementII.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementII.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.CentromereDNAElementII.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.CentromereDNAElementIIShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.CentromereDNAElementII");
        if (centromere != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.CentromereDNAElementIIShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.CentromereDNAElementII)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementII.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.CentromereDNAElementII.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
