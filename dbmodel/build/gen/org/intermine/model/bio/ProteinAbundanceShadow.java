...
public class ProteinAbundanceShadow implements ProteinAbundance, ShadowClass
{
    public static final Class<ProteinAbundance> shadowOf = ProteinAbundance.class;
    // Attr: org.intermine.model.bio.ProteinAbundance.units
    protected java.lang.String units;
    public java.lang.String getUnits() { return units; }
    public void setUnits(final java.lang.String units) { this.units = units; }

    // Attr: org.intermine.model.bio.ProteinAbundance.source
    ...
    // Attr: org.intermine.model.bio.ProteinAbundance.assay
    ...
    // Attr: org.intermine.model.bio.ProteinAbundance.treatment
    ...
    // Attr: org.intermine.model.bio.ProteinAbundance.treatmentTime
    protected java.lang.String treatmentTime;
    public java.lang.String getTreatmentTime() { return treatmentTime; }
    public void setTreatmentTime(final java.lang.String treatmentTime) { this.treatmentTime = treatmentTime; }

    // Attr: org.intermine.model.bio.ProteinAbundance.strainBackground
    ...
    // Attr: org.intermine.model.bio.ProteinAbundance.abundance
    protected java.lang.Float abundance;
    public java.lang.Float getAbundance() { return abundance; }
    public void setAbundance(final java.lang.Float abundance) { this.abundance = abundance; }

    // Attr: org.intermine.model.bio.ProteinAbundance.visualization
    protected java.lang.String visualization;
    public java.lang.String getVisualization() { return visualization; }
    public void setVisualization(final java.lang.String visualization) { this.visualization = visualization; }

    // Attr: org.intermine.model.bio.ProteinAbundance.foldChange
    protected java.lang.String foldChange;
    public java.lang.String getFoldChange() { return foldChange; }
    public void setFoldChange(final java.lang.String foldChange) { this.foldChange = foldChange; }

    // Attr: org.intermine.model.bio.ProteinAbundance.media
    protected java.lang.String media;
    public java.lang.String getMedia() { return media; }
    public void setMedia(final java.lang.String media) { this.media = media; }

    // Ref: org.intermine.model.bio.ProteinAbundance.publication
    ...
    // Ref: org.intermine.model.bio.ProteinAbundance.origPublication
    protected org.intermine.model.InterMineObject origPublication;
    public org.intermine.model.bio.Publication getOrigPublication() { if (origPublication instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Publication) ((org.intermine.objectstore.proxy.ProxyReference) origPublication).getObject()); }; return (org.intermine.model.bio.Publication) origPublication; }
    public void setOrigPublication(final org.intermine.model.bio.Publication origPublication) { this.origPublication = origPublication; }
    public void proxyOrigPublication(final org.intermine.objectstore.proxy.ProxyReference origPublication) { this.origPublication = origPublication; }
    public org.intermine.model.InterMineObject proxGetOrigPublication() { return origPublication; }

    // Col: org.intermine.model.bio.ProteinAbundance.proteins
    ...
    @Override public boolean equals(Object o) { return (o instanceof ProteinAbundance && id != null) ? id.equals(((ProteinAbundance)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "ProteinAbundance [abundance=" + abundance + ", assay=" + (assay == null ? "null" : "\"" + assay + "\"") + ", foldChange=" + (foldChange == null ? "null" : "\"" + foldChange + "\"") + ", id=" + id + ", media=" + (media == null ? "null" : "\"" + media + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", origPublication=" + (origPublication == null ? "null" : (origPublication.getId() == null ? "no id" : origPublication.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", strainBackground=" + (strainBackground == null ? "null" : "\"" + strainBackground + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", treatment=" + (treatment == null ? "null" : "\"" + treatment + "\"") + ", treatmentTime=" + (treatmentTime == null ? "null" : "\"" + treatmentTime + "\"") + ", units=" + (units == null ? "null" : "\"" + units + "\"") + ", visualization=" + (visualization == null ? "null" : "\"" + visualization + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("origPublication".equals(fieldName)) {
            if (origPublication instanceof ProxyReference) {
                return ((ProxyReference) origPublication).getObject();
            } else {
                return origPublication;
            }
        }
        ...
        if (!org.intermine.model.bio.ProteinAbundance.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("treatmentTime".equals(fieldName)) {
            treatmentTime = (java.lang.String) value;
        } else if ("strainBackground".equals(fieldName)) {
            strainBackground = (java.lang.String) value;
        } else if ("abundance".equals(fieldName)) {
            abundance = (java.lang.Float) value;
        } else if ("visualization".equals(fieldName)) {
            visualization = (java.lang.String) value;
        } else if ("foldChange".equals(fieldName)) {
            foldChange = (java.lang.String) value;
        } else if ("media".equals(fieldName)) {
            media = (java.lang.String) value;
        } else if ("publication".equals(fieldName)) {
            publication = (org.intermine.model.InterMineObject) value;
        } else if ("origPublication".equals(fieldName)) {
            origPublication = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ProteinAbundance.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ProteinAbundance.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ProteinAbundanceShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ProteinAbundance");
        if (units != null) {
        ...
        if (treatmentTime != null) {
            sb.append("$_^atreatmentTime$_^");
            String string = treatmentTime;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (abundance != null) {
            sb.append("$_^aabundance$_^").append(abundance);
        }
        if (visualization != null) {
            sb.append("$_^avisualization$_^");
            String string = visualization;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (foldChange != null) {
            sb.append("$_^afoldChange$_^");
            String string = foldChange;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (origPublication != null) {
            sb.append("$_^rorigPublication$_^").append(origPublication.getId());
        }
        if (sgdAlias != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ProteinAbundanceShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ProteinAbundance)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "atreatmentTime".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                treatmentTime = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "aabundance".equals(notXml[i])) {
                i++;
                abundance = Float.valueOf(notXml[i]);
                i++;
            }
            if ((i < notXml.length) && "avisualization".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                visualization = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "afoldChange".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                foldChange = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "amedia".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                media = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) &&"rorigPublication".equals(notXml[i])) {
                i++;
                origPublication = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Publication.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ProteinAbundance.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ProteinAbundance.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
