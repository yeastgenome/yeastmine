...
public class CentromereDNAElementIIIShadow implements CentromereDNAElementIII, ShadowClass
{
    public static final Class<CentromereDNAElementIII> shadowOf = CentromereDNAElementIII.class;
    // Ref: org.intermine.model.bio.CentromereDNAElementIII.centromere
    protected org.intermine.model.InterMineObject centromere;
    public org.intermine.model.bio.Centromere getCentromere() { if (centromere instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Centromere) ((org.intermine.objectstore.proxy.ProxyReference) centromere).getObject()); }; return (org.intermine.model.bio.Centromere) centromere; }
    public void setCentromere(final org.intermine.model.bio.Centromere centromere) { this.centromere = centromere; }
    public void proxyCentromere(final org.intermine.objectstore.proxy.ProxyReference centromere) { this.centromere = centromere; }
    public org.intermine.model.InterMineObject proxGetCentromere() { return centromere; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementIII.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("centromere".equals(fieldName)) {
            centromere = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("centromere".equals(fieldName)) {
            return org.intermine.model.bio.Centromere.class;
        }
        if ("briefDescription".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementIII.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.CentromereDNAElementIII.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.CentromereDNAElementIIIShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.CentromereDNAElementIII");
        if (centromere != null) {
            sb.append("$_^rcentromere$_^").append(centromere.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.CentromereDNAElementIIIShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.CentromereDNAElementIII)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rcentromere".equals(notXml[i])) {
                i++;
                centromere = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Centromere.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CentromereDNAElementIII.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.CentromereDNAElementIII.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
