...
public class InsertionShadow implements Insertion, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.Insertion.xelementcombinatorialrepeat
    protected org.intermine.model.InterMineObject xelementcombinatorialrepeat;
    public org.intermine.model.bio.XElementCombinatorialRepeat getXelementcombinatorialrepeat() { if (xelementcombinatorialrepeat instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.XElementCombinatorialRepeat) ((org.intermine.objectstore.proxy.ProxyReference) xelementcombinatorialrepeat).getObject()); }; return (org.intermine.model.bio.XElementCombinatorialRepeat) xelementcombinatorialrepeat; }
    public void setXelementcombinatorialrepeat(final org.intermine.model.bio.XElementCombinatorialRepeat xelementcombinatorialrepeat) { this.xelementcombinatorialrepeat = xelementcombinatorialrepeat; }
    public void proxyXelementcombinatorialrepeat(final org.intermine.objectstore.proxy.ProxyReference xelementcombinatorialrepeat) { this.xelementcombinatorialrepeat = xelementcombinatorialrepeat; }
    public org.intermine.model.InterMineObject proxGetXelementcombinatorialrepeat() { return xelementcombinatorialrepeat; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("xelementcombinatorialrepeat".equals(fieldName)) {
            xelementcombinatorialrepeat = (org.intermine.model.InterMineObject) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (xelementcombinatorialrepeat != null) {
            sb.append("$_^rxelementcombinatorialrepeat$_^").append(xelementcombinatorialrepeat.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rxelementcombinatorialrepeat".equals(notXml[i])) {
                i++;
                xelementcombinatorialrepeat = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.XElementCombinatorialRepeat.class);
                i++;
            };
