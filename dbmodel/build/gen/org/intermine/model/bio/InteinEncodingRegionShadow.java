...
public class InteinEncodingRegionShadow implements InteinEncodingRegion, ShadowClass
{
    public static final Class<InteinEncodingRegion> shadowOf = InteinEncodingRegion.class;
    // Ref: org.intermine.model.bio.InteinEncodingRegion.orf
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.InteinEncodingRegion.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.InteinEncodingRegion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.InteinEncodingRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.InteinEncodingRegionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.InteinEncodingRegion");
        if (orf != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.InteinEncodingRegionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.InteinEncodingRegion)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.InteinEncodingRegion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.InteinEncodingRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
