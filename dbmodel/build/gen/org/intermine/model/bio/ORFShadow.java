...
public class ORFShadow implements ORF, ShadowClass
{
    public static final Class<ORF> shadowOf = ORF.class;
    // Col: org.intermine.model.bio.ORF.plus1translationalframeshifts
    protected java.util.Set<org.intermine.model.bio.Plus1TranslationalFrameshift> plus1translationalframeshifts = new java.util.HashSet<org.intermine.model.bio.Plus1TranslationalFrameshift>();
    public java.util.Set<org.intermine.model.bio.Plus1TranslationalFrameshift> getPlus1translationalframeshifts() { return plus1translationalframeshifts; }
    public void setPlus1translationalframeshifts(final java.util.Set<org.intermine.model.bio.Plus1TranslationalFrameshift> plus1translationalframeshifts) { this.plus1translationalframeshifts = plus1translationalframeshifts; }
    public void addPlus1translationalframeshifts(final org.intermine.model.bio.Plus1TranslationalFrameshift arg) { plus1translationalframeshifts.add(arg); }

    // Col: org.intermine.model.bio.ORF.inteinencodingregions
    protected java.util.Set<org.intermine.model.bio.InteinEncodingRegion> inteinencodingregions = new java.util.HashSet<org.intermine.model.bio.InteinEncodingRegion>();
    public java.util.Set<org.intermine.model.bio.InteinEncodingRegion> getInteinencodingregions() { return inteinencodingregions; }
    public void setInteinencodingregions(final java.util.Set<org.intermine.model.bio.InteinEncodingRegion> inteinencodingregions) { this.inteinencodingregions = inteinencodingregions; }
    public void addInteinencodingregions(final org.intermine.model.bio.InteinEncodingRegion arg) { inteinencodingregions.add(arg); }

    // Col: org.intermine.model.bio.ORF.uORFs
    protected java.util.Set<org.intermine.model.bio.uORF> uORFs = new java.util.HashSet<org.intermine.model.bio.uORF>();
    public java.util.Set<org.intermine.model.bio.uORF> getUORFs() { return uORFs; }
    public void setUORFs(final java.util.Set<org.intermine.model.bio.uORF> uORFs) { this.uORFs = uORFs; }
    public void addUORFs(final org.intermine.model.bio.uORF arg) { uORFs.add(arg); }

    // Col: org.intermine.model.bio.ORF.fiveprimeutrintrons
    protected java.util.Set<org.intermine.model.bio.FivePrimeUTRIntron> fiveprimeutrintrons = new java.util.HashSet<org.intermine.model.bio.FivePrimeUTRIntron>();
    public java.util.Set<org.intermine.model.bio.FivePrimeUTRIntron> getFiveprimeutrintrons() { return fiveprimeutrintrons; }
    public void setFiveprimeutrintrons(final java.util.Set<org.intermine.model.bio.FivePrimeUTRIntron> fiveprimeutrintrons) { this.fiveprimeutrintrons = fiveprimeutrintrons; }
    public void addFiveprimeutrintrons(final org.intermine.model.bio.FivePrimeUTRIntron arg) { fiveprimeutrintrons.add(arg); }

    // Col: org.intermine.model.bio.ORF.telomericRepeats
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ORF.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("plus1translationalframeshifts".equals(fieldName)) {
            plus1translationalframeshifts = (java.util.Set) value;
        } else if ("inteinencodingregions".equals(fieldName)) {
            inteinencodingregions = (java.util.Set) value;
        } else if ("uORFs".equals(fieldName)) {
            uORFs = (java.util.Set) value;
        } else if ("fiveprimeutrintrons".equals(fieldName)) {
            fiveprimeutrintrons = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ORF.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ORF.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ORFShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ORF");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ORFShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ORF)");
        }
        ...
        plus1translationalframeshifts = new ProxyCollection<org.intermine.model.bio.Plus1TranslationalFrameshift>(os, this, "plus1translationalframeshifts", org.intermine.model.bio.Plus1TranslationalFrameshift.class);
        inteinencodingregions = new ProxyCollection<org.intermine.model.bio.InteinEncodingRegion>(os, this, "inteinencodingregions", org.intermine.model.bio.InteinEncodingRegion.class);
        uORFs = new ProxyCollection<org.intermine.model.bio.uORF>(os, this, "uORFs", org.intermine.model.bio.uORF.class);
        fiveprimeutrintrons = new ProxyCollection<org.intermine.model.bio.FivePrimeUTRIntron>(os, this, "fiveprimeutrintrons", org.intermine.model.bio.FivePrimeUTRIntron.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("plus1translationalframeshifts".equals(fieldName)) {
            plus1translationalframeshifts.add((org.intermine.model.bio.Plus1TranslationalFrameshift) element);
        } else if ("inteinencodingregions".equals(fieldName)) {
            inteinencodingregions.add((org.intermine.model.bio.InteinEncodingRegion) element);
        } else if ("uORFs".equals(fieldName)) {
            uORFs.add((org.intermine.model.bio.uORF) element);
        } else if ("fiveprimeutrintrons".equals(fieldName)) {
            fiveprimeutrintrons.add((org.intermine.model.bio.FivePrimeUTRIntron) element);
        } else if ("telomericRepeats".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("plus1translationalframeshifts".equals(fieldName)) {
            return org.intermine.model.bio.Plus1TranslationalFrameshift.class;
        }
        if ("inteinencodingregions".equals(fieldName)) {
            return org.intermine.model.bio.InteinEncodingRegion.class;
        }
        if ("uORFs".equals(fieldName)) {
            return org.intermine.model.bio.uORF.class;
        }
        if ("fiveprimeutrintrons".equals(fieldName)) {
            return org.intermine.model.bio.FivePrimeUTRIntron.class;
        }
        if ("telomericRepeats".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.ORF.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ORF.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
