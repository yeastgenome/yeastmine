...
public class DiseaseShadow implements Disease, ShadowClass
{
    ...
    @Override public String toString() { return "Disease [id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + "]"; }
