...
public class LongTerminalRepeatShadow implements LongTerminalRepeat, ShadowClass
{
    public static final Class<LongTerminalRepeat> shadowOf = LongTerminalRepeat.class;
    // Attr: org.intermine.model.bio.LongTerminalRepeat.geneSummary
    ...
    @Override public boolean equals(Object o) { return (o instanceof LongTerminalRepeat && id != null) ? id.equals(((LongTerminalRepeat)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "LongTerminalRepeat [briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", featAttribute=" + (featAttribute == null ? "null" : "\"" + featAttribute + "\"") + ", featureType=" + (featureType == null ? "null" : "\"" + featureType + "\"") + ", geneSummary=" + (geneSummary == null ? "null" : "\"" + geneSummary + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", qualifier=" + (qualifier == null ? "null" : "\"" + qualifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", status=" + (status == null ? "null" : "\"" + status + "\"") + ", strain=" + (strain == null ? "null" : (strain.getId() == null ? "no id" : strain.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", yprimeelement=" + (yprimeelement == null ? "null" : (yprimeelement.getId() == null ? "no id" : yprimeelement.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.LongTerminalRepeat.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.LongTerminalRepeat.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.LongTerminalRepeat.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.LongTerminalRepeatShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.LongTerminalRepeat");
        if (geneSummary != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.LongTerminalRepeatShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.LongTerminalRepeat)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.LongTerminalRepeat.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.LongTerminalRepeat.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
