...
public class TransposableElementGeneShadow implements TransposableElementGene, ShadowClass
{
    public static final Class<TransposableElementGene> shadowOf = TransposableElementGene.class;
    // Col: org.intermine.model.bio.TransposableElementGene.plus1translationalframeshifts
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.TransposableElementGene.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.TransposableElementGene.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.TransposableElementGene.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.TransposableElementGeneShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.TransposableElementGene");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.TransposableElementGeneShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.TransposableElementGene)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.TransposableElementGene.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.TransposableElementGene.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
