...
public class ProteinHalfLifeShadow implements ProteinHalfLife, ShadowClass
{
    public static final Class<ProteinHalfLife> shadowOf = ProteinHalfLife.class;
    // Attr: org.intermine.model.bio.ProteinHalfLife.units
    protected java.lang.String units;
    public java.lang.String getUnits() { return units; }
    public void setUnits(final java.lang.String units) { this.units = units; }

    // Attr: org.intermine.model.bio.ProteinHalfLife.source
    ...
    // Attr: org.intermine.model.bio.ProteinHalfLife.experiment
    ...
    // Attr: org.intermine.model.bio.ProteinHalfLife.value
    ...
    // Ref: org.intermine.model.bio.ProteinHalfLife.publication
    ...
    // Col: org.intermine.model.bio.ProteinHalfLife.proteins
    ...
    @Override public boolean equals(Object o) { return (o instanceof ProteinHalfLife && id != null) ? id.equals(((ProteinHalfLife)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "ProteinHalfLife [experiment=" + (experiment == null ? "null" : "\"" + experiment + "\"") + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", units=" + (units == null ? "null" : "\"" + units + "\"") + ", value=" + value + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ProteinHalfLife.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ProteinHalfLife.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ProteinHalfLife.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ProteinHalfLifeShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ProteinHalfLife");
        if (units != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ProteinHalfLifeShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ProteinHalfLife)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ProteinHalfLife.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ProteinHalfLife.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
