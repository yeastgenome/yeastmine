...
public class Z2_regionShadow implements Z2_region, ShadowClass
{
    public static final Class<Z2_region> shadowOf = Z2_region.class;
    // Ref: org.intermine.model.bio.Z2_region.matingtyperegion
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Z2_region.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Z2_region.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Z2_region.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.Z2_regionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Z2_region");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.Z2_regionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Z2_region)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Z2_region.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Z2_region.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
