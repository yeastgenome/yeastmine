...
public class Z1_regionShadow implements Z1_region, ShadowClass
{
    public static final Class<Z1_region> shadowOf = Z1_region.class;
    // Ref: org.intermine.model.bio.Z1_region.matingtyperegion
    protected org.intermine.model.InterMineObject matingtyperegion;
    public org.intermine.model.bio.MatingTypeRegion getMatingtyperegion() { if (matingtyperegion instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.MatingTypeRegion) ((org.intermine.objectstore.proxy.ProxyReference) matingtyperegion).getObject()); }; return (org.intermine.model.bio.MatingTypeRegion) matingtyperegion; }
    public void setMatingtyperegion(final org.intermine.model.bio.MatingTypeRegion matingtyperegion) { this.matingtyperegion = matingtyperegion; }
    public void proxyMatingtyperegion(final org.intermine.objectstore.proxy.ProxyReference matingtyperegion) { this.matingtyperegion = matingtyperegion; }
    public org.intermine.model.InterMineObject proxGetMatingtyperegion() { return matingtyperegion; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Z1_region.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("matingtyperegion".equals(fieldName)) {
            matingtyperegion = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("matingtyperegion".equals(fieldName)) {
            return org.intermine.model.bio.MatingTypeRegion.class;
        }
        if ("briefDescription".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.Z1_region.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Z1_region.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.Z1_regionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Z1_region");
        if (matingtyperegion != null) {
            sb.append("$_^rmatingtyperegion$_^").append(matingtyperegion.getId());
        }
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.Z1_regionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Z1_region)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rmatingtyperegion".equals(notXml[i])) {
                i++;
                matingtyperegion = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.MatingTypeRegion.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Z1_region.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Z1_region.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
