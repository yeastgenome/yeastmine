...
public class NotInSystematicSequenceOfS288CShadow implements NotInSystematicSequenceOfS288C, ShadowClass
{
    public static final Class<NotInSystematicSequenceOfS288C> shadowOf = NotInSystematicSequenceOfS288C.class;
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.NotInSystematicSequenceOfS288C.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.NotInSystematicSequenceOfS288C.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.NotInSystematicSequenceOfS288C.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.NotInSystematicSequenceOfS288CShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.NotInSystematicSequenceOfS288C");
        if (geneSummary != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.NotInSystematicSequenceOfS288CShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.NotInSystematicSequenceOfS288C)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.NotInSystematicSequenceOfS288C.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.NotInSystematicSequenceOfS288C.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
